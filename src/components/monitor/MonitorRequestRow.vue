<template>
  ...
  >
    ...
    <div style="width: 140px;" class="text-truncate ui-text-primary flex-shrink-0 cursor-copy" :title="request.domain" @click="$emit('copy', request.domain)">
      {{ request.domain }}
    </div>
...
const getMethodClass = (method) => {
  const classes = { 'GET': 'ui-tag-primary', 'POST': 'ui-tag-success', 'PUT': 'ui-tag-warning', 'DELETE': 'ui-tag-danger', 'PATCH': 'ui-tag-info' }
