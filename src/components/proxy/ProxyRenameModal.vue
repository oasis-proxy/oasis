<template>
  <BaseModal :visible="visible" :title="title || $t('prmTitle')" @close="emit('close')">
    <div class="d-flex flex-column gap-3">
      ...
      <label class="d-flex flex-column gap-2 w-100">
        ...
        <div
          class="ui-input px-3 rounded-lg border text-xs ui-text-secondary d-flex align-items-center overflow-hidden"
          :title="currentName"
        >
