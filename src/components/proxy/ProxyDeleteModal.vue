      ...
      <div class="d-flex items-start gap-3 text-sm ui-text-secondary ">
          ...
          <div>
              ...
              <p class="opacity-90 leading-relaxed m-0">
                  {{ $t('pdmMsgDeleteConfirm') }} <span class="fw-bold underline ui-text-primary d-inline-block text-truncate align-bottom" style="max-width: 15rem;" :title="proxyName">{{ proxyName }}</span>? 
