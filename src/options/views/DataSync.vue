          ...
          >
            ...
            <div class="form-check form-switch">
              <input
                ...
                @change="toggleAutoSync($event.target.checked)"
          ...
          >
            ...
            <div class="d-flex gap-2">
              ...
              <button
                ...
                class="fw-medium ui-button-secondary border rounded-lg transition-colors d-flex align-items-center gap-2"
              >
              ...
              <button
                @click="onClearLocal"
                class="fw-medium ui-button-danger border rounded-lg transition-colors d-flex align-items-center gap-2"
              >
        ...
        <div class="d-flex justify-content-center gap-4">
          <div class="flex-1 d-flex justify-content-center">
            <button
              ...
              class="d-flex align-items-center gap-2 px-4 py-2 ui-button-secondary rounded-lg border transition-all"
            >
