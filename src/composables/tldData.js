...
// prettier-ignore
const SL_PREFIXES = [
  'com', 'net', 'org', 'gov', 'edu', 'mil', 'int', 'co', 'ac', 'or', 'go', 'ne', 'in', 'id',
  'ltd', 'plc', 'me', 'nhs', 'gob', 'sch', 'mod', 'ngo', 're', 'law', 'gen', 'per', 'ind',
  'biz', 'idv', 'nom', 'nic', 'res', 'web'
]
 ...
 * @type {Set<string>}
 */
export const COMPOUND_TLDS = new Set(CCTLDS.flatMap((cc) => SL_PREFIXES.map((sl) => `${sl}.${cc}`)))
